...
import com.starsky.meteor.controller.message.ACKMessageI;
...
@Entity
@Table(name = "message", schema = "meteor", catalog = "")
public class MessageEntity extends DBBean implements ACKMessageI {
    private int id;
